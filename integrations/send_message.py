...
# Eskiz API uchun login ma'lumotlari - environment variables dan olish
EMAIL = os.getenv("ESKIZ_EMAIL", "abdulbosit19980204@gmail.com")
PASSWORD = os.getenv("ESKIZ_PASSWORD", "XFd3a0W2n1sBim9hf0uIKRNstbe6ArQafNiDm62O")
